...
const CLUBS = [
  { slug:'penarol',      name:'Peñarol',            pais:'Uruguay',    c1:'#f5d000', c2:'#111' },
  { slug:'nacional',     name:'Nacional',           pais:'Uruguay',    c1:'#0a3d91', c2:'#fff' },
  { slug:'danubio',      name:'Danubio',            pais:'Uruguay',    c1:'#1f4fa0', c2:'#fff' },
  { slug:'defensor',     name:'Defensor Sporting',  pais:'Uruguay',    c1:'#6a2fa0', c2:'#fff' },
  { slug:'liverpool-uy', name:'Liverpool',          pais:'Uruguay',    c1:'#0b0b0b', c2:'#1f4fa0' },
  { slug:'boca',         name:'Boca Juniors',       pais:'Argentina',  c1:'#0d1b53', c2:'#f2c200' },
  { slug:'river',        name:'River Plate',        pais:'Argentina',  c1:'#fff',    c2:'#d81e33' },
  { slug:'racing',       name:'Racing Club',        pais:'Argentina',  c1:'#6cace4', c2:'#fff' },
  { slug:'independiente',name:'Independiente',      pais:'Argentina',  c1:'#c8102e', c2:'#fff' },
  { slug:'san-lorenzo',  name:'San Lorenzo',        pais:'Argentina',  c1:'#0b2c6f', c2:'#c8102e' },
  { slug:'barcelona',    name:'Barcelona',          pais:'España',     c1:'#a50044', c2:'#004d98' },
  { slug:'real-madrid',  name:'Real Madrid',        pais:'España',     c1:'#fff',    c2:'#febe10' },
  { slug:'atletico',     name:'Atlético de Madrid', pais:'España',     c1:'#c8102e', c2:'#fff' },
  { slug:'sevilla',      name:'Sevilla',            pais:'España',     c1:'#fff',    c2:'#c8102e' },
  { slug:'man-united',   name:'Manchester United',  pais:'Inglaterra', c1:'#da291c', c2:'#fbe122' },
  { slug:'man-city',     name:'Manchester City',    pais:'Inglaterra', c1:'#6caddf', c2:'#fff' },
  { slug:'liverpool',    name:'Liverpool FC',       pais:'Inglaterra', c1:'#c8102e', c2:'#00b2a9' },
  { slug:'arsenal',      name:'Arsenal',            pais:'Inglaterra', c1:'#ef0107', c2:'#fff' },
  { slug:'chelsea',      name:'Chelsea',            pais:'Inglaterra', c1:'#034694', c2:'#fff' },
  { slug:'tottenham',    name:'Tottenham',          pais:'Inglaterra', c1:'#fff',    c2:'#132257' },
  { slug:'juventus',     name:'Juventus',           pais:'Italia',     c1:'#fff',    c2:'#111' },
  { slug:'milan',        name:'Milan',              pais:'Italia',     c1:'#fb090b', c2:'#111' },
  { slug:'inter',        name:'Inter',              pais:'Italia',     c1:'#0068a8', c2:'#111' },
  { slug:'napoli',       name:'Napoli',             pais:'Italia',     c1:'#12a0d7', c2:'#fff' },
  { slug:'roma',         name:'Roma',               pais:'Italia',     c1:'#8e1f2f', c2:'#f0bc42' },
  { slug:'bayern',       name:'Bayern Múnich',      pais:'Alemania',   c1:'#dc052d', c2:'#fff' },
  { slug:'dortmund',     name:'Borussia Dortmund',  pais:'Alemania',   c1:'#fde100', c2:'#111' },
  { slug:'psg',          name:'PSG',                pais:'Francia',    c1:'#004170', c2:'#da291c' },
  { slug:'flamengo',     name:'Flamengo',           pais:'Brasil',     c1:'#c52613', c2:'#111' },
  { slug:'palmeiras',    name:'Palmeiras',          pais:'Brasil',     c1:'#006437', c2:'#fff' },
];
const BY_SLUG = {};
...
// Escudo generado con los colores del club (evita logos con derechos).
...
async function _cabecera(club){
  ...
  el.innerHTML = `<div style="display:flex;align-items:center;gap:13px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.09);border-radius:16px;padding:14px 15px;">
    ...
    <button onclick="window.CancheroHinchada.pickClub()" title="Cambiar de club" style="background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);color:#aaa;border-radius:10px;padding:7px 10px;font-size:14px;cursor:pointer;flex-shrink:0;"><i class='bx bx-edit-alt'></i></button>
  </div>`;
}
