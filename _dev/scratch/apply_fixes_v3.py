...
"""
    ...
    match = old_viewer_regex.search(content)
    if match:
        content = content.replace(match.group(0), club_viewer_fix)

    with open(path, 'w', encoding='utf-8') as f:
        f.write(content)
        print("script.js patched for club viewer and shield preview (v3).")
